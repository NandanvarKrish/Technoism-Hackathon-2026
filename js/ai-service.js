...
window.AiService = {
  ...
  // Internal Question Generation with Retry
  async executeQuestionGenerationRequest(targetRole, jobDescription, resumeText, count = 3, isRetry = false) {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        try {
          // Construct role-tailored questions using JD and resume context without inventing candidate facts
          ...
          // Tailor questions to explicit role & resume highlights
  ...
  // Perform Semantic AI ATS Analysis
  ...
  // Execute AI Answer Evaluation with Single Retry
